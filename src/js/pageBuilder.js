  ...
  pagesHtml += `
    <div class="page page-cover">
      <div class="page-content" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;">
        ...
        <div style="margin-top: 60px; color: var(--gold); font-size: 11px; display: flex; flex-direction: column; align-items: center; gap: 8px; opacity: 0.8; text-transform: uppercase; letter-spacing: 2px;">
          <span>Arraste para folhear</span>
      ...
      pagesHtml += `
        <div class="page">
          <div class="page-content">
            ...
            ` : `
              <h2 class="book-cat-title" style="font-size: 20px; opacity: 0.8;">${cat.title} <span style="font-size: 14px; font-weight: normal;">(cont.)</span></h2>
